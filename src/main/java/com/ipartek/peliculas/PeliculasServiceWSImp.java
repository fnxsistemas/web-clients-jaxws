...
public interface PeliculasServiceWSImp {
    ...
    @RequestWrapper(localName = "obtenertodo", targetNamespace = "http://com.ipartek.formacion/types", className = "com.ipartek.peliculas.Obtenertodo")
    @ResponseWrapper(localName = "obtenertodoResponse", targetNamespace = "http://com.ipartek.formacion/types", className = "com.ipartek.peliculas.ObtenertodoResponse")
    public PeliculaMensaje obtenertodo();
